...
$('#photoCover').val($(this).val());
                ...
                <div class="col-md-4 col-md-offset-0" >
                    ...
                    <table class="table table-hover " style="margin-top:0px"id="userDataTable">
                        ...
                        <h2 style="margin-top:0px">First Name </h2>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-0" style="background-color:white;width:100%">
                    <table class="table " style="text-decoration:none;" id="userDataTable">
                        ...
                        <tr>
                            <td style="border-color:white"><h5><font style="font-weight:600">Industry : </font>Shipping Industry</h5></td>
                            <td style="border-color:white"><h5><font style="font-weight:600">Business : </font>Cargo Mangement</h5></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="border-color:white"><h5><font style="font-weight:600">PAN : </font>GJLPA7416P</h5></td>
                            <td style="border-color:white"><h5><font style="font-weight:600">Company :</font> ABC Shipping</h5></td>
                        </tr>
                        <tr>
